...
<fieldset class="behinderungen">
	<div class="behinderung ruestung">
		...
		<div class="value">
			<g:field type="number" min="-3" max="0" name="ruestung-wert" id="charakter-behinderung-ruestung-wert" class="value" value="0"
				data-updates="new Array({target:'${talenttypSelector}', message:(function(el){return \$('#charakter-behinderung-ruestung').val()}), value:(function(el){return \$(el).val()})})" />
